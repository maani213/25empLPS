    ...
    public class RijndaelCrypt
    {
        ...
        public static string EncryptString(string InputText)
        {
            try
            {
                ...
                byte[] Salt = Encoding.ASCII.GetBytes(Pswrd.Length.ToString());

                // The (Secret Key) will be generated from the specified password and salt.
                PasswordDeriveBytes SecretKey = new PasswordDeriveBytes(Pswrd, Salt);
        ...
        public static string EncryptPassword(string plainPassword, string saltValue)
        {
            try
            {
                // We are now going to create an instance of the Rihndael class.
        ...
        public static string DecryptPassword(string passwordHash, string saltValue)
        {
            try
            {
                RijndaelManaged RijndaelCipher = new RijndaelManaged();
